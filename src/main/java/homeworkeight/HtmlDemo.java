...
// пример взаимодействия JPanel с html версткой
public class HtmlDemo extends JPanel
    ...
    //Реакция на нажатие пользователем кнопок
     ...
     * Для безопасности потока, этот метод должен быть вызван из потока отправки событий.
     */
...
// Запланировать задание для потока отправки событий:
// создание и отображение графического интерфейса этого приложения.
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                // Отключение использование жирных шрифтов
